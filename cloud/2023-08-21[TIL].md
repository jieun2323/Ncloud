...
- 하이퍼바이저(13p)
    - 위치와 역할에 따라서 분류된다.
        - type1: Native 2에 비해 유연하다
            - Native 하이퍼바이저에는
            
            IBM Xen, Vmware ESX Server,
            MS Hyper-V 가
            
            type1은 가상화 방식에 따른 분류
        ...
        - type2 : Hosted OS위에 다양한 하이퍼바이저를 올릴 수 있다.
            ...
            - Hosted 하이퍼바이저에는 VMware Server, VMware Workstation,
